...
<html>
	...
	<body>
		<form class="cd-form" method="POST" action="#">
			...
			<legend>Registro de Miembro</legend>
	...
	<?php
		if(isset($_POST['m_login']))
		{
			...
			if(mysqli_num_rows($result) != 1)
				echo error_without_field("Nombre de Usuario incorrecto/Contraseña incorrecta");
			else 
			{
				$resultRow = mysqli_fetch_array($result);
				$balance = $resultRow[1];
				if($balance < 0)
					echo error_without_field("Tu cuenta ha sido suspendida. Póngase en contacto con un bibliotecario para obtener más información.");
				else
				{
